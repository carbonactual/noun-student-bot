...
-- Only non-sensitive reference data is public. Student/checklist/operational tables have no public policies.
...
-- The server uses SUPABASE_SERVICE_ROLE_KEY. Never expose that key to the browser.
