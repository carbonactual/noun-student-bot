...
const OFFICIAL_KNOWLEDGE = [
  ...
  'The October 2026 MCP timetable shows MF301 + MF302 Tuesday morning, MF303 + MF402 Tuesday afternoon, MF401 Wednesday morning, MF403 Tuesday morning as the Digital Finance elective, and MF404 Wednesday afternoon as the SME elective. Each listed MCP paper is 1.5 hours, so a two-paper 3-hour session is not itself a clash; candidates should select only the elective permitted by the current programme rule.',
...
function fallbackAnswer(message) {
  ...
  if (/\b(6|six)\b.*\bcours|mf301|mf302|mf303|mf401|mf402|mf403|mf404/.test(q)) {
    return [
      ...
      'For October 2026, the published timetable shows MF403 in the Wednesday morning session and MF404 in the Wednesday afternoon session. Confirm the elective actually selected in your CIBN portal before payment.'
    ].join('\n');
  }
