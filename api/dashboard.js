...
module.exports = async function handler(req, res) {
  try {
    ...
    const [{ count: students }, { count: active_students }, { count: checklists }, { count: open_help }, { count: upcoming_deadlines }, levels, courses, deadlines, campaigns] = await Promise.all([
